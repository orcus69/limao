...
import 'package:caracolibras/app/modules/home/presenter/view/content_view.dart';
...
class HomeModule extends WidgetModule {
  ...
  void routes(r) {
    ...
    r.child('/view/content', child: (ctx) => ContentView(content: r.args.data as ContentModuleModel));
  }
